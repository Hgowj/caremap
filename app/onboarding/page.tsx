...
export default function OnboardingPage() {
  ...
  const handleFinish = async () => {
    const prefs = { userType, mobilityAid, slope, sheltered, restStops, washroomAccess, washroomFreq };
  ...
  return (
    <div className="flex flex-col h-full bg-white">
      ...
      <div className="flex items-center justify-between px-5 pt-5 pb-1">
        ...
        <button onClick={() => router.push("/map")} className="text-xs text-gray-400">Skip</button>
      </div>
      ...
      {step === "account" && (
        <div className="flex-1 flex flex-col px-5">
          ...
          <p className="text-sm text-gray-500 mb-6">
            {isLogin ? "Log in to access your saved routes and preferences." : "Save your routes, bookmarks, and preferences."}
          </p>
      ...
      {step === "who" && (
        <div className="flex-1 flex flex-col px-5">
          ...
          <p className="text-sm text-gray-500 mb-8">We&apos;ll tailor routes to the right needs</p>

          <div className="space-y-3">
            {[
              { id: "senior",   label: "I'm a senior",  sub: "65 and above",              icon: "👤" },
