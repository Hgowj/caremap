...
var BuildId = "TZ3LK1JxxwBw10iszzgYl";
...
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/api/auth/register/route": "/api/auth/register", "/api/saved/route": "/api/saved", "/api/auth/login/route": "/api/auth/login", "/api/route/route": "/api/route", "/api/pois/route": "/api/pois", "/api/reports/[id]/confirm/route": "/api/reports/[id]/confirm", "/api/reverse-geocode/route": "/api/reverse-geocode", "/api/user/preferences/route": "/api/user/preferences", "/api/reports/route": "/api/reports", "/api/search/route": "/api/search", "/api/facilities/route": "/api/facilities", "/events/page": "/events", "/map/page": "/map", "/onboarding/page": "/onboarding", "/settings/page": "/settings", "/page": "/", "/reports/page": "/reports", "/saved/page": "/saved" };
