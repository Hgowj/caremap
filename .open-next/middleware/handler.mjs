...
var BuildId = "bt5_g_2qpWuV6FeJqrcx2";
...
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/api/agent/route": "/api/agent", "/api/auth/login/route": "/api/auth/login", "/api/facilities/route": "/api/facilities", "/api/notes/[id]/confirm/route": "/api/notes/[id]/confirm", "/api/auth/register/route": "/api/auth/register", "/api/notes/route": "/api/notes", "/api/pois/route": "/api/pois", "/api/reverse-geocode/route": "/api/reverse-geocode", "/api/route/route": "/api/route", "/api/search/route": "/api/search", "/api/user/preferences/route": "/api/user/preferences", "/api/saved/route": "/api/saved", "/page": "/", "/notes/page": "/notes", "/facilities/page": "/facilities", "/saved/page": "/saved", "/onboarding/page": "/onboarding", "/map/page": "/map", "/settings/page": "/settings" };
