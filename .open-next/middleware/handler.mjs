...
var BuildId = "Mv9BQ6l_NEuVRW03NYp79";
...
var AppPathRoutesManifest = { "/api/agent/route": "/api/agent", "/api/facilities/route": "/api/facilities", "/api/auth/register/route": "/api/auth/register", "/api/notes/[id]/confirm/route": "/api/notes/[id]/confirm", "/api/pois/route": "/api/pois", "/api/notes/route": "/api/notes", "/api/auth/login/route": "/api/auth/login", "/api/reverse-geocode/route": "/api/reverse-geocode", "/api/search/route": "/api/search", "/api/saved/route": "/api/saved", "/api/route/route": "/api/route", "/api/user/preferences/route": "/api/user/preferences", "/_not-found/page": "/_not-found", "/facilities/page": "/facilities", "/notes/page": "/notes", "/page": "/", "/map/page": "/map", "/onboarding/page": "/onboarding", "/saved/page": "/saved", "/settings/page": "/settings" };
