...
var BuildId = "wtBqxREulfQSE0TJZSk2W";
...
var AppPathRoutesManifest = { "/api/auth/login/route": "/api/auth/login", "/_not-found/page": "/_not-found", "/api/notes/[id]/confirm/route": "/api/notes/[id]/confirm", "/api/facilities/route": "/api/facilities", "/api/auth/register/route": "/api/auth/register", "/api/notes/route": "/api/notes", "/api/pois/route": "/api/pois", "/api/route/route": "/api/route", "/api/search/route": "/api/search", "/api/reverse-geocode/route": "/api/reverse-geocode", "/api/user/preferences/route": "/api/user/preferences", "/api/saved/route": "/api/saved", "/facilities/page": "/facilities", "/page": "/", "/saved/page": "/saved", "/onboarding/page": "/onboarding", "/settings/page": "/settings", "/notes/page": "/notes", "/map/page": "/map" };
