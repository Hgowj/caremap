...
var BuildId = "yMxmC3iJei0L37k9lrgIw";
...
var AppPathRoutesManifest = { "/api/auth/login/route": "/api/auth/login", "/api/auth/register/route": "/api/auth/register", "/api/facilities/route": "/api/facilities", "/api/notes/[id]/confirm/route": "/api/notes/[id]/confirm", "/api/notes/route": "/api/notes", "/api/pois/route": "/api/pois", "/api/reverse-geocode/route": "/api/reverse-geocode", "/api/route/route": "/api/route", "/api/saved/route": "/api/saved", "/api/search/route": "/api/search", "/api/user/preferences/route": "/api/user/preferences", "/_not-found/page": "/_not-found", "/facilities/page": "/facilities", "/page": "/", "/map/page": "/map", "/onboarding/page": "/onboarding", "/settings/page": "/settings", "/notes/page": "/notes", "/saved/page": "/saved" };
