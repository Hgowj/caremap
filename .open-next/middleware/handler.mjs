...
var BuildId = "Zem_cmDkX53R3sBSX6QDk";
...
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/api/auth/register/route": "/api/auth/register", "/api/notes/[id]/confirm/route": "/api/notes/[id]/confirm", "/api/agent/route": "/api/agent", "/api/pois/route": "/api/pois", "/api/notes/route": "/api/notes", "/api/search/route": "/api/search", "/api/saved/route": "/api/saved", "/api/auth/login/route": "/api/auth/login", "/api/route/route": "/api/route", "/api/reverse-geocode/route": "/api/reverse-geocode", "/api/user/preferences/route": "/api/user/preferences", "/api/facilities/route": "/api/facilities", "/onboarding/page": "/onboarding", "/facilities/page": "/facilities", "/notes/page": "/notes", "/page": "/", "/map/page": "/map", "/saved/page": "/saved", "/settings/page": "/settings" };
