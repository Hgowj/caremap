...
var BuildId = "pDsiWACcJH2_Cr2ZSD7hC";
var HtmlPages = ["/404"];
...
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/api/auth/login/route": "/api/auth/login", "/api/facilities/route": "/api/facilities", "/api/auth/register/route": "/api/auth/register", "/api/notes/[id]/confirm/route": "/api/notes/[id]/confirm", "/api/agent/route": "/api/agent", "/api/notes/route": "/api/notes", "/api/pois/route": "/api/pois", "/api/reverse-geocode/route": "/api/reverse-geocode", "/api/route/route": "/api/route", "/api/search/route": "/api/search", "/api/user/preferences/route": "/api/user/preferences", "/api/saved/route": "/api/saved", "/facilities/page": "/facilities", "/saved/page": "/saved", "/map/page": "/map", "/settings/page": "/settings", "/notes/page": "/notes", "/page": "/", "/onboarding/page": "/onboarding" };
