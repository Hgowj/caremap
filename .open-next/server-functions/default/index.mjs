...
var BuildId = "sONbKhzqXZsuQJH2AXZJK";
var HtmlPages = ["/404"];
...
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/api/auth/login/route": "/api/auth/login", "/api/agent/route": "/api/agent", "/api/facilities/route": "/api/facilities", "/api/auth/register/route": "/api/auth/register", "/api/notes/[id]/confirm/route": "/api/notes/[id]/confirm", "/api/notes/route": "/api/notes", "/api/pois/route": "/api/pois", "/api/reverse-geocode/route": "/api/reverse-geocode", "/api/saved/route": "/api/saved", "/api/route/route": "/api/route", "/api/search/route": "/api/search", "/api/user/preferences/route": "/api/user/preferences", "/facilities/page": "/facilities", "/map/page": "/map", "/onboarding/page": "/onboarding", "/page": "/", "/notes/page": "/notes", "/settings/page": "/settings", "/saved/page": "/saved" };
